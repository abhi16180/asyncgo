...
func (_m *Executor) NewFixedWorkerPool(options *quasar.Options) quasar.WorkerPool {
...
func (_m *Executor) Submit(function interface{}, args ...interface{}) (*quasar.Future, error) {
	var _ca []interface{}
