...
func (_m *ExecutorService) NewFixedWorkerPool(options *wp.Options) wp.WorkerPoolImpl {
	...
	var r0 wp.WorkerPoolImpl
	if rf, ok := ret.Get(0).(func(*wp.Options) wp.WorkerPoolImpl); ok {
		r0 = rf(options)
	} else {
		r0 = ret.Get(0).(wp.WorkerPoolImpl)
	}
